...
const ProspectsPage: React.FC = () => {
  ...
  // State to track initial prospect count before processing
  const [totalProspectsFound, setTotalProspectsFound] = useState<number | null>(null);
  ...
  const searchProspects = async () => {
    ...
    setTotalProspectsFound(null); // Clear previous total count
    ...
    try {
      ...
      // Store the total count of initial prospects found
      setTotalProspectsFound(Array.isArray(initialProspects) ? initialProspects.length : 0);
          ...
          <div className="px-4 py-5 border-b border-gray-200 sm:px-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                {/* Display total prospects found and limit information */}
                {totalProspectsFound !== null && (
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="text-sm text-blue-800">
                        <p className="font-medium">
                          Total prospects found: <span className="font-bold">{totalProspectsFound}</span>
                        </p>
                        {filters.limit && totalProspectsFound > filters.limit && (
                          <p className="mt-1">
                            Only considering the first <span className="font-bold">{filters.limit}</span> prospects based on your search limit.
                          </p>
                        )}
                      </div>
                    </div>
